...
CauldronBlock = Material('Cauldron Block', 'U',DGREY)       #[cb82] Added stuph
EmeraldBlock = Material('Emerald Block', 'e',BGREEN)        #[cb82]
BirchStairs = Material('Birch Stairs', 'L',RED)             #[cb82]
EnchantmentTable = Material('Enchantment Table', '@',RED)   #[cb82]
BrewingStand = Material('Brewing Stand', '@',RED)           #[cb82]
IronBlock = Material('Iron Block', 'o',CYAN)                #[cb82]
NetherWart = Material('Nether Wart', 'W',PURPLE)            #[cb82]
GoldenCarrot = Material('Golden Carrot', 'C',BYELLOW)       #[cb82]
Crops = Material('Crops', 'c',BYELLOW)                      #[cb82]
